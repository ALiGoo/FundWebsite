...
from fundapp.views import index, index_response, test, test_respoonse, test_show, search

urlpatterns = [
    path('admin/', admin.site.urls),
    path('index/page=<int:page>', index_response),
    path('index/', index),
    path('test/', test),
    path('search/column=<str:column> keyword=<str:keyword>',search),
